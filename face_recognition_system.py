...
image_of_person_1 = face_recognition.load_image_file("known_people/person1.jpeg")
image_of_person_2 = face_recognition.load_image_file("known_people/person2.jpeg")
image_of_person_3 = face_recognition.load_image_file("known_people/person3.jpeg")
...
unknown_image = face_recognition.load_image_file( "unknowns/unknown1.jpeg")
print("unkonwn image loaded...")
# Get face encodings for any people in the picture
unknown_face_encodings = face_recognition.face_encodings(unknown_image)


# This block can be used for better recognizing smaller faces.
